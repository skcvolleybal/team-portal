...
class TelFluitGateway
{
    ...
    public function GetFluitEnTelbeurtenFor(Persoon $user, bool $includeHistoric = false): array
    {
        // Conditionally set the timestamp filter based on $includeHistoric
        $timestampCondition = $includeHistoric ? '' : 'AND W.timestamp >= CURRENT_TIMESTAMP()';
